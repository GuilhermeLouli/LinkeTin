export default ChatsListMock = [
  ...
  },
  {
    ...
    unreadMessages: 0,
    name: 'Jollies',
    users: ['@janneyy', '@missjourney', '@andreww'],
    status: 'audio'
  },
  {
    id: 3,
    ...
    unreadMessages: 0,
    name: 'The Backroom',
    users: ['@janneyy', '@missjourney', '@andreww', '@someone'],
    status: 'sent'
  },
  {
    id: 4,
    ...
    unreadMessages: 4,
    name: '@missjourney1',
    users: ['@janneyy', '@missjourney', '@andreww', '@someone', '@someoneElse'],
    status: 'what do you mean it doesnt look good?'
  },
  {
    id: 5,
    pictures: ['https://images.pexels.com/photos/3796217/pexels-photo-3796217.jpeg?auto=compress&cs=tinysrgb&w=1200'],
  ...
  },
  {
    ...
    unreadMessages: 16,
    name: '@missjourney5',
    status: '@jenna actually something',
    sender: '@annaaustin'
  },
  {
    id: 9,
    ...
    unreadMessages: 16,
    name: '@missjourney6',
    status: 'I suppose we will meet in the morning of friday',
    sender: '@jenna'
  },
  {
    id: 10,
